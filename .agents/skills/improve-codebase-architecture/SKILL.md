...
description: >-
  Scans a codebase for shallow modules worth deepening, then proposes and interrogates architectural refactors.
---
...
- **Want to explore alternative interfaces for the deepened module?** Run the codebase-design processes and use design-it-twice parallel sub-agent patterns.
