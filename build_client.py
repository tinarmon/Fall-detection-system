...
def build():
    ...
    manual_content = """========================================================================
คู่มือการใช้งาน: ระบบประเมินความเสี่ยงและตรวจจับก่อนการล้มสไตล์ 3D (Pre-Fall Detection 3D v1.1.0)
========================================================================
...
1. เมื่อเปิดหน้าแรก หากยังไม่มีการเชื่อมต่อ ให้กดปุ่ม "+ Add Stream"
2. กรอกการตั้งค่ากล้อง:
   ...
   - Camera Source:
     ...
     * หากเป็นกล้องเน็ตเวิร์ก IP Camera: ให้กรอกลิงก์ RTSP ช่อง Sub-stream แนะนำความลื่นไหลสูง (เช่น "rtsp://admin:password@192.168.1.100:554/stream2")
...
* ข้อมูลกล้องทั้งหมดจะบันทึกในไฟล์ "client_config.json" อัตโนมัติ

------------------------------------------------------------------------
🚨 ระบบเตือนภัยล้ม (Fall Alert) และ LINE Messaging API
------------------------------------------------------------------------
- เมื่อ AI ตรวจพบการล้ม ระบบจะทำการ:
  1. สกัดภาพหลักฐาน 5 เฟรมต่อเนื่อง (เฟรมคู่ 2, 4, 6, 8, 10) รวมเป็น Collage รูปเดียว
  2. ส่งเป็นการ์ดเตือนภัย Flex Message สีแดงเข้า LINE ของคุณทันที พร้อมภาพหลักฐานและปุ่มโทร 1669
  3. บันทึกคลิปวิดีโอ .mp4 และภาพถ่ายลงในเครื่องคอมพิวเตอร์ (โฟลเดอร์ recorded_falls/)
  4. สามารถกดปุ่ม "📁 Fall Clips" ด้านบนโปรแกรม เพื่อเปิดดูโฟลเดอร์คลิปวิดีโอได้ทันที

- การตั้งค่ารับการแจ้งเตือน LINE:
  1. ทักบอทในแอป LINE เพื่อรับรหัส User ID ของคุณ
  2. นำรหัส User ID มาใส่ในช่อง "👤 LINE User / Group ID ผู้รับ" ด้านล่างของโปรแกรม
  3. กด "💾 บันทึก ID" และกด "🧪 ทดสอบส่ง" เพื่อตรวจสอบการทำงานได้ทันที
