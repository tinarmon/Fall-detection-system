...
def run_analysis():
    ...
    try:
        ...
        print("     - คำนวณจาก ไหล่ -> สะโพก -> เข่า (มีค่าระหว่าง 0.0 ถึง 1.0 ซึ่งก็คือองศาหารด้วย 180)")
        print("     - หากคนยืนตัวตรง มุมจะใกล้ 1.0 (180 องศา). เมื่อล้มหรือพับตัว มุมจะหดเล็กลงอย่างเห็นได้ชัด")
        print("  5. พิกัดสำคัญ (x11, y11 ถึง x26, y26):")
        print("     - พิกัด x, y ของข้อต่อหลัก 6 จุด (ไหล่ สะโพก เข่า ซ้ายและขวา) เป็นค่า Normalized (0.0 ถึง 1.0)")
        print("     - แกน Y (y11-y26): พิกัดแนวตั้ง. เมื่อล้มลง ค่า Y ของทุกจุดจะเพิ่มขึ้น (เพราะตำแหน่งร่วงลงสู่พื้นด้านล่าง)")
        print("="*70)
